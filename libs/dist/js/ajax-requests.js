$(function() {
    ...
    function renderUrl(filtered, id) {
        switch (filtered) {
            case 'area':
                return 'http://172.16.200.11/gestoasimaotoco/membro/areasbytribo/' + id;
                break;
            case 'provincia_eclesiastica':
                return 'http://172.16.200.11/gestoasimaotoco/membro/peclesiasticasbyigreja/' + id;
                break;
            case 'paroquia':
                return 'http://172.16.200.11/gestoasimaotoco/membro/paroquiasbypeclesiastica/' + id;
                break;
            case 'classe':
                return 'http://172.16.200.11/gestoasimaotoco/membro/classesbyparoquia/' + id;
                break;
            default:
                break;
        }
