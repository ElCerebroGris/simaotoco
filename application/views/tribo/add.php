...
<html>
    <head>
        ...
        <title>Simão Toco | Adicionar Tribo</title>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card card-success">
                                    ...
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <form role="form" method="post" action="<?= base_url() ?>tribo/addPost">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                                    <label for="nome">Descrição</label>
                                                    <input name="descricao_tribo" type="text" class="form-control" required="">
                                                </div>
                                                <div class="form-group col-md-6">
                                                </div>
                                            </div>
