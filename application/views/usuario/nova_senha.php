    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            <div class="login-logo">
                <a href="../../index2.html"><b>CEFO</b>PESCAS</a>
            </div>
            <!-- /.login-logo -->
            <div class="card">
                <div class="card-body login-card-body">
                    ...
                    <form action="login.html" method="post">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <button type="submit" class="btn btn-primary btn-block">Mudar a senha</button>
                            </div>
                            <!-- /.col -->
                        </div>
                    </form>
                    ...
                    <p class="mt-3 mb-1">
                        <a href="<?= base_url() ?>welcome/entrar">Entrar no sistema</a>
                    </p>
                </div>
                <!-- /.login-card-body -->
            </div>
