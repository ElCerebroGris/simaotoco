...
<main>
        <div class="main-content">
            ...
            <div class="form-login">
                <form class="validate-form" action="<?= base_url() ?>usuario/recuperar_senhaPost" method="post">
					...
					<span class="focus-input100"></span>
						...
						<input class="input100" type="password" placeholder="Nova Senha" name="password" required data-validate = "Email is required">
					</p>
					<p >
					<span class="focus-input100"></span>
						<span class="symbol-input100">
						...
						<input class="input100" type="password" placeholder="Confirmação" name="confirm" required data-validate = "Email is required">
					</p>
                ...
                <p> <a class="txt2" href="<?= base_url() ?>welcome/entrar">
							Entrar no Sistema
						</a></p>
            </div>
        </div>
