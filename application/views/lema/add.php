                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card card-success">
                                    ...
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <form role="form" method="post" action="<?= base_url() ?>lema/addPost">
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-8">
                                                    ...
                                                    <input name="lema" type="text" class="form-control" required="">
                                                </div>
                                                <div class="form-group col-md-2">
                                                    <label for="nome">Estado <sup>(opcional)</sup></label>
                                                    <input name="status" type="checkbox" class="form-control" style="width: 20px !important;">
                                                </div>
                                            </div>
                                            <div class="card">
