            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <?php if ($this->session->userdata('nivel') == 1) { ?>
                        <h5 class="mb-2">
                            <a href="<?= base_url() ?>correspondencia/add" class="btn btn-outline-primary btn-sm  ">Nova Correspondencia</a>
                        </h5>
                    <?php } ?>
                </div>
                <div class="col-sm-6">
                            ...
                            <table id="example1" class="table table-bordered table-striped table-sm table-f-s-2">
                                ...
                                <tbody style="color:black">
                                    <?php foreach ($documentos as $u) { ?>
                                        <tr>
                                            <td><a href="<?= base_url() . 'docs/' . $u->doc_url ?>" target="_blank"><?= $u->doc_url ?></a></td>
                                            <td><?= $u->nome_usuario ?></td>
                                            <td><?= $u->destino_descricao ?></td>
                                            <td><?= $u->data_criacao ?></td>
                                            <td>
                                                <a target="blank" href="<?= base_url() . 'docs/' . $u->doc_url ?>" class="btn btn-outline-secondary btn-sm"><i class="fa fa-print"></i></a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
