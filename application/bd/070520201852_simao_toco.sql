...
--
-- Host: 127.0.0.1
-- Generation Time: 07-Maio-2020 às 19:50
...
INSERT INTO `categoria` (`id_categoria`, `descricao_categoria`, `estado_categoria`, `data_criacao`, `data_atualizacao`) VALUES
(1, 'Membro', 1, '2020-05-07 14:16:52', '0000-00-00 00:00:00');
...
INSERT INTO `identificacao` (`identificacao_id`, `pessoa_id`, `descricao_identificacao`, `estado_identificacao`, `data_criacao`, `tipo_identificacao`) VALUES
(1, 1, '1111111111', 1, '2020-05-07 14:18:51', 'BI');
...
INSERT INTO `membro` (`membro_id`, `pessoa_id`, `area_id`, `classe_id`, `data_admissao`, `data_baptismo`, `id_categoria`, `id_funcao`, `estado_membro`, `data_criacao`, `data_atualizacao`) VALUES
(1, 1, 1, 1, '111111', NULL, 1, 1, 1, '2020-05-07 14:15:45', '0000-00-00 00:00:00');
...
CREATE TABLE `pagamento` (
  ...
  `membro_id` int(11) NOT NULL,
  `tipo_pagamento` enum('DIZIMO','QUOTA','OFERTAS','OUTRO') DEFAULT 'DIZIMO',
...
INSERT INTO `pagamento` (`pagamento_id`, `membro_id`, `tipo_pagamento`, `mes_referencia`, `valor`, `usuario_id`, `data_criacao`) VALUES
(1, 1, 'DIZIMO', '2020-05', 12000, 1, '2020-05-07 14:27:51'),
(2, 1, 'OFERTAS', '2020-05', 111110, 1, '2020-05-07 14:33:43');
...
CREATE TABLE `pessoa` (
  ...
  `data_criacao` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `data_atualizacao` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' ON UPDATE CURRENT_TIMESTAMP,
  `estado_civil` enum('SOLTEIRO','CASAD0','DIVORCIADO','VIUVO') DEFAULT 'SOLTEIRO',
...
INSERT INTO `pessoa` (`pessoa_id`, `pessoa_nome`, `nome_pai`, `nome_mae`, `id_nacionalidade`, `data_nascimento`, `telefone`, `endereco`, `estado_pessoa`, `data_criacao`, `data_atualizacao`, `estado_civil`, `sexo`) VALUES
(1, 'osvaldo calombe', 'AAAA', 'BBB', 1, '1111111', '', '', 1, '2020-05-07 14:15:09', '0000-00-00 00:00:00', 'SOLTEIRO', 'MASCULINO');
...
--
ALTER TABLE `identificacao`
  MODIFY `identificacao_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `membro`
  MODIFY `membro_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `pessoa`
  MODIFY `pessoa_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
