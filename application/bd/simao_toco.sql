...
--
-- Host: 127.0.0.1
-- Generation Time: 07-Maio-2020 às 12:22
...
--
ALTER TABLE `igreja_nacional`
  MODIFY `igreja_nacional_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `paroquia`
  MODIFY `paroquia_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `provincia_eclesiastica`
  MODIFY `provincia_eclesiastica_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tribo`
--
ALTER TABLE `tribo`
  MODIFY `tribo_id` int(11) NOT NULL AUTO_INCREMENT;
